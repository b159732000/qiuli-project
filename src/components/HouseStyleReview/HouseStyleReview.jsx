...
class HouseStyleReview extends React.Component {
    ...
    componentDidMount() {
        new Swiper(this.houseStyleSwiperID, {});    //掛載swiper到DOM houseStyleSwiperID
            ...
            <div className="HouseStyleReview">
                ...
                <div className="pager">
                    ...
                    <div className="barContainer">
                        <ul>
                            <li className={(this.state.currentHouseStyleIndex === 1) ? ("active") : ("")} onClick={() => this.handlePagerClick(1)}>A</li>
                            <li className={(this.state.currentHouseStyleIndex === 2) ? ("active") : ("")} onClick={() => this.handlePagerClick(2)}>B</li>
                            <li className={(this.state.currentHouseStyleIndex === 3) ? ("active") : ("")} onClick={() => this.handlePagerClick(3)}>C</li>
                            <li className={(this.state.currentHouseStyleIndex === 4) ? ("active") : ("")} onClick={() => this.handlePagerClick(4)}>D</li>
                            <li className={(this.state.currentHouseStyleIndex === 5) ? ("active") : ("")} onClick={() => this.handlePagerClick(5)}>E</li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="mainImgContainer" onTouchStart={(event) => this.handleMainImageTouchStart(event)} onTouchMove={(event) => this.handleMainImageTouchMove(event)}>
                    ...
                    {/*<img src={showroomImages[this.state.showroom.currentImageIndex]} alt="" />*/}
                    <Iframe src="http://hvr.isunupcg.com/james/qiuli-project/gifViewer/index.html" width="100%" height="100%" frameBorder="0"></Iframe>
                    {/*<Iframe src="http://hvr.isunupcg.com/james/cuihu-optimize/w1.html" width="100%" height="100%" frameBorder="2px solid black"></Iframe>*/}
                </div>
